...
SECRET_KEY = 'django-insecure-^k*2c+mfnr5%2yg@^rp6gp!0$xur_=$d7sck8455vmx!lao9-2'
...
MIDDLEWARE = [
    ...
    'junox.middleware.TokenAutoRefreshMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'junox.context_processors.api_version_info',
            ],
        },
    },
]
